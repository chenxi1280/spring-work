...
layui.use(['table', 'upload', 'layer', 'laydate'], function () {
            ...
            [ //表头
                ...
                },
                {
                    ...
                    templet: function (d) {
                        ...
                        // date.setTime(d.acreatedate);
                        // return date.Format("yyyy-MM-dd hh:mm:ss");

                        console.log(d)
                        return showTime(d.acreatedate);
        ...
        switch (obj.event) {
            case 'add':
                layer.open({
                    ...
                    title: '新建用户',
                    area: ['50%', '80%'],
                    content: '../templates/addadmin.html'
                })
    ...
    table.on('tool(usertest)', function (obj) { //注：tool 是工具条事件名，test 是 table 原始容器的属性 lay-filter="对应的值"
        ...
        if (layEvent === 'detail') {
            layer.open({
                ...
                title: '查看业主',
                area: ['50%', '80%'],
                content: '/admin/geteditadmin' + '?aid=' + data.aid,
    ...
    $("#find").on("click", function () {
        ...
        table.reload('userdemo', {
            ...
            url: "/admin/selectByLikeUsername",
            where: {//设置异步请求的参数
